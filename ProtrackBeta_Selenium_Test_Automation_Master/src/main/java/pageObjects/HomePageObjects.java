...
public class HomePageObjects extends TestBase{
	...
	By profile = By.xpath("//a[@aria-label='Open user options menu']//span");
	...
	public void clickProfile() {
		click_custom(DriverFactory.getInstance().getDriver().findElement(profile),"Profile");
	}
	
	public void clickSignOut() {
		click_custom(DriverFactory.getInstance().getDriver().findElement(signout),"Sign Out");
	}
}
